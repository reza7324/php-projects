            ...
            <ul class="nav flex-column pe-3">
                ...
                <li class="nav-item">
                    <a
                        ...
                        href="/1_php-project-blog/admin-panel/pages/posts/index.php">
                        <i
                            class="bi bi-file-earmark-image-fill fs-4 <?= (str_contains($path, 'posts')) ? 'text-secondary' : '' ?>"></i>
                ...
                <li class="nav-item">
                    <a
                        ...
                        href="/1_php-project-blog/admin-panel/pages/categories/index.php">
                        <i
                            class="bi bi-folder-fill fs-4 <?= (str_contains($path, 'categories')) ? 'text-secondary' : '' ?>"></i>
                ...
                <li class="nav-item">
                    <a
                        ...
                        href="/1_php-project-blog/admin-panel/pages/comments/index.php">
                        <i
                            class="bi bi-chat-left-text-fill fs-4 <?= (str_contains($path, 'comments') )? 'text-secondary' : '' ?>"></i>
                ...
                <li class="nav-item">
                    <a
                        ...
                        href="/1_php-project-blog/admin-panel/pages/auth/logout.php">
                        <i
